...
So
one sender -> two workers scenario
"""
...
CS_2.sendCMD('echo "2"',WORKER_ID_2,'os',2)


dependencies_cmd_4 = [
	{"cmd_id" : 1,"result_code" : 0, "worker_id" : WORKER_ID_1},
	{"cmd_id" : 2,"result_code" : 0, "worker_id" : WORKER_ID_2},
]
...
CS_1.sendCMD('echo "6"',WORKER_ID_1,'os',6)

dependencies_cmd_5 = [
	{"cmd_id" : 6,"result_code" : 0, "worker_id" : WORKER_ID_1},
	{"cmd_id" : 7,"result_code" : 0, "worker_id" : WORKER_ID_2},
	{"cmd_id" : 8,"result_code" : 0, "worker_id" : WORKER_ID_2}
]

CS_1.sendCMD('echo "5"',WORKER_ID_1,'os',5, dependencies_cmd_5)

CS_2.sendCMD('echo "7"',WORKER_ID_2,'os',7)
CS_2.sendCMD('echo "8"',WORKER_ID_2,'os',8)
CS_2.sendCMD('echo "9"',WORKER_ID_2,'os',9)
